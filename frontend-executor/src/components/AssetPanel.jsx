  ...
  if (!assets) {
    return (
      <div className="exec-sidebar-section">
        <div className="exec-sidebar-title">资产</div>
        <div style={{ color: "var(--exec-text-secondary)", fontSize: 12 }}>加载中...</div>
      </div>
    );
  }
  ...
  return (
    <div className="exec-sidebar-section">
      ...
      {assets.positions && assets.positions.length > 0 && (
        <>
          <div className="exec-sidebar-title" style={{ marginTop: 8 }}>持仓</div>
