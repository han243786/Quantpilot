...
use qrpc_core::{
    AgentConfig, CompiledRuntimeProtocol, DataKind, DataSourceConfig, IntentConfig, IntentKind,
...
mod tests {
    use super::*;
    use qrpc_core::{
        DataRequirement, DataRequirementType, Exchange, IndicatorDefinition, IndicatorKind,
        KnownOrUnknown, LogicAction, LogicRule, MarketType, PositionSizing, PositionSizingMethod,
        PositionSizingUnit, RiskConfig, SignalDefinition, StrategyExecution, StrategyIr,
        StrategyLogic, StrategyMetadata, StrategyRiskRules, StrategySource, StrategySourceType,
        Symbol,
    };
    use serde_json::json;
