...
> 当前版本: v3.7.1 | 当前里程碑: V1 收口前的流程基线
> 状态: v2.x✅ v3.0.x✅ v3.1.0✅ v3.2.x✅ v3.3.0✅ v3.4.x✅ v3.5.x✅ v3.7.0✅ v3.7.1⚠️
...
| 03 | `v3.7.1/03-closeout.md` | 流程基线、门禁收口、剩余发布风险 | ⚠️ 完整 closeout 待执行 |
