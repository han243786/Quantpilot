...
> 当前版本: v4.3.0 | 当前 closeout: v4 回测 + 多交易对策略
> 状态: v2.x✅ v3.0.x✅ v3.1.0✅ v3.2.x✅ v3.3.0✅ v3.4.x✅ v3.5.x✅ v3.7.0✅ v3.7.1✅ v3.7.2✅ v4.0.0📋 v4.1.0✅ v4.2.0✅ v4.3.0🔧

---

## 当前活跃

### v4.3.0 — v4 回测 + 多交易对策略 (MINOR, 实施中) 🔧

| # | 文档 | 内容 | 状态 |
|---|------|------|:--:|
| 01 | `v4.3.0/01-规划方案.md` | v4 回测引擎、`v4_artifact`、回测详情 evidence、v4 模板、多交易对 MachineGraph 展开 | 🔧 Codex 正在落实 |

### v3.7.2 — Closeout 真实性与安全回退收口 (PATCH) ✅

| # | 文档 | 内容 | 状态 |
|---|------|------|:--:|
| 01 | `v3.7.2/01-规划方案.md` | 全量检查发现的 closeout/E2E/文档口径/测试副作用收口方案 | ✅ 推荐方案已落实 |
| 02 | `v3.7.2/02-综合优化清单.md` | S0/P1/P2/P3 优化清单、根因、方案和执行顺序 | ✅ 主体已落实 |
| 03 | `v3.7.2/03-验收标准.md` | 23 项门禁、safe fallback、文档真实口径、测试副作用和 clippy 语义验收 | ✅ 已通过 |
| 04 | `v3.7.2/04-closeout.md` | 2026-05-24 closeout 归档结果，23/23 通过 | ✅ 已归档 |

### v4.0.0 — 状态机化 QuantScript + 开发者学习流水线 (MAJOR, closeout 执行中) 📋

| # | 文档 | 内容 | 状态 |
|---|------|------|:--:|
| 01 | `v4.0.0/01-规划方案.md` | 顶层 DAG + 节点内状态机、QS 状态机 DSL、事件模型、Risk Plane、ExecutionMachine 能力矩阵、学习流水线 | 📋 终稿已敲定 |

### v3.7.1 — GP 10.3 回归补丁 + 流程收口 (PATCH) ⚠️

| # | 文档 | 内容 | 状态 |
|---|------|------|:--:|
| 01 | `v3.7.1/01-规划方案.md` | S0 登录挂起 / P1 凭证 DELETE 405 / P2 测试文件锁 | ✅ 已落实 |
| 02 | `v3.7.1/02-综合优化清单.md` | 三项回归修复的依赖顺序和验收标准 | ✅ 已落实 |
| 03 | `v3.7.1/03-closeout.md` | 流程基线、门禁收口、剩余发布风险 | ⚠️ 当前最新全量检查以 v3.7.2 为准 |
