...
> 当前版本: v2.1.3 (closeout) | 下一版本: v2.2.0 (规划中)

---

## 当前活跃

### v2.2.0 — 架构重构 + i18n 完整化 + 可观测性

| # | 文档 | 内容 | 状态 |
|---|------|------|:--:|
| 01 | `v2.2.0/01-设计文档.md` | 5大目标: Runtime拆分/thiserror/tracing/i18n/TLS, 2项决策纪录 | 🟡 设计中 |

### v2.1.3 — 全量清零 + 5轮诱错 + 审计闭环
...
| # | 文档 | 内容 | 状态 |
|---|------|------|:--:|
| 01 | `v2.1.0/01-优化优先级清单.md` | P1(49)+P2(50+)+P3(30+) 按7模块分组 | ✅ 已完成 (纳入v2.1.x消化) |
...
| # | 文档 | 内容 | 状态 |
|---|------|------|:--:|
| 01 | `v1.1.1/01-规划方案.md` | S0(2)+P1(6)+P2(8)+P3(5) 方案，2 个决策纪录，GP 对照表 | 🔴 规划中 |
| 02 | `v1.1.1/02-综合优化清单.md` | 21 项按 S0/P1/P2/P3 分组 | 🔴 待开始 |
