...
> 当前版本: v4.7.0 | 当前功能里程碑: v4.11.0 v4 策略配置系统一等化 📋 | 当前治理里程碑: v4.14.0 治理门禁自动化 🚧
> 状态: v2.x✅ v3.x✅ v4.0.0✅ v4.1.0✅ v4.2.0✅ v4.3.0✅ v4.4.0✅ v4.5.0✅ v4.6.0✅ v4.7.0✅ v4.8.x✅ v4.9.0✅ v4.10.0✅ v4.11.0📋 v4.12.0✅ v4.13.0✅ v4.14.0🚧
...
### v4.14.0 — 治理门禁自动化 (MINOR governance, 执行中)

| # | 文档 | 内容 | 状态 |
|---|------|------|:--:|
| 01 | `v4.14.0/01-规划方案.md` | 三矩阵声明、引导坐标、模块树漂移、发布过渡保护和 closeout 接入 | 🚧 执行中 |
| 02 | `v4.14.0/02-落地记录.md` | 治理 gate 第一波自动化、closeout 26 项接入和验证记录 | 🚧 执行中 |
