...
> 当前版本: v3.7.1 | 当前补丁规划: v3.7.2 closeout 真实性与安全回退收口 | 下一大版本规划: v4.0.0 状态机化 QuantScript + 开发者学习流水线
> 状态: v2.x✅ v3.0.x✅ v3.1.0✅ v3.2.x✅ v3.3.0✅ v3.4.x✅ v3.5.x✅ v3.7.0✅ v3.7.1✅ v3.7.2✅ v4.0.0📋
...
### v4.0.0 — 状态机化 QuantScript + 开发者学习流水线 (MAJOR, 终稿规划) 📋
