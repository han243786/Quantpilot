...
> 当前版本: v4.7.0 | 当前功能里程碑: v4.11.0 v4 策略配置系统一等化 📋 | 当前治理里程碑: v4.12.0 三矩阵治理入口启用 🚧
> 状态: v2.x✅ v3.x✅ v4.0.0✅ v4.1.0✅ v4.2.0✅ v4.3.0✅ v4.4.0✅ v4.5.0✅ v4.6.0✅ v4.7.0✅ v4.8.x✅ v4.9.0✅ v4.10.0✅ v4.11.0📋 v4.12.0🚧
> 后续优化: 功能线只在已登记的非账户、非策略搜索/筛选边界内推进；治理线按 v4.12.0 至 v4.15.0 完成三矩阵接管。

---

## 当前活跃

### v4.12.0 — 三矩阵治理入口启用 (MINOR governance, 执行中)

| # | 文档 | 内容 | 状态 |
|---|------|------|:--:|
| 01 | `v4.12.0/01-规划方案.md` | 三矩阵治理入口、三档执行、父子通信、发布过渡协议和总索引接入 | 🚧 执行中 |
| 02 | `v4.12.0/02-落地记录.md` | v4.12.0 工作线状态、硬规则确认、验证记录和后续缺口分流 | 🚧 执行中 |
| 03 | `../00-matrix-governance/landing-roadmap.md` | v4.12.0 至 v4.15.0 完全落地路线 | 🚧 已铺设 |

### v4.13.0 — 模块树白箱扩面 (MINOR governance, 规划)

| # | 文档 | 内容 | 状态 |
|---|------|------|:--:|
| 01 | `v4.13.0/01-规划方案.md` | active 模块、关键 public 方法、模块化重构通道和回归保护矩阵 | 📋 已创建 |

### v4.14.0 — 治理门禁自动化 (MINOR governance, 规划)

| # | 文档 | 内容 | 状态 |
|---|------|------|:--:|
| 01 | `v4.14.0/01-规划方案.md` | 三矩阵声明、引导坐标、模块树漂移、发布过渡保护和 closeout 接入 | 📋 已创建 |

### v4.15.0 — 三矩阵完全接管 closeout (MINOR governance, 规划)

| # | 文档 | 内容 | 状态 |
|---|------|------|:--:|
| 01 | `v4.15.0/01-规划方案.md` | 旧入口导流、模块树覆盖、治理 gate 和完全接管 closeout | 📋 已创建 |
