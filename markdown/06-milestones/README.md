...
| 04 | `../09-archive/testing-retired/自由维度诱错审计-v4.7.0-第1轮.md` | 5维度30发现: 1 S0 + 2 S1 + 6 P1 + 13 P2 + 8 P3 | ✅ S0/S1/P1 已修复 |
| 05 | `../09-archive/testing-retired/自由维度诱错审计-v4.7.0-第2轮.md` | 3维度20发现: 1 P1 + 10 P2 + 8 P3 + 8 PASS；P1/P2-1 已修复 | ✅ 报告已归档 |
...
| 03 | `../09-archive/testing-retired/v1.1.0-审计报告.md` | 五维度评分 9.5/10，GP 合规 30/32 ✅ | ✅ 已完成 |
...
| v4.16.0 / BE-001RE-01 | `v4.16.0/995-root.contracts.qrpc_core.strategy_ir.root_validation.risk_validation.baseline_plan.md` | `root.contracts.qrpc_core.strategy_ir.root_validation.risk_validation` baseline plan |
| v4.16.0 / BE-001RE-02 | `v4.16.0/996-root.contracts.qrpc_core.strategy_ir.root_validation.risk_validation.extract_closeout.md` | `root.contracts.qrpc_core.strategy_ir.root_validation.risk_validation` actual extraction complete |
...
| v4.16.0 / BE-001RG-03 | `v4.16.0/1001-root.contracts.qrpc_core.strategy_ir.root_validation.data_execution_validation.single_leaf_closeout.md` | `root.contracts.qrpc_core.strategy_ir.root_validation.data_execution_validation` single leaf closeout |
| v4.16.0 / BE-001RH-01 | `v4.16.0/1002-root.contracts.qrpc_core.strategy_ir.root_validation.parent_residual_judgment.unknown_marker_validation.md` | `root.contracts.qrpc_core.strategy_ir.root_validation` selects `unknown_marker_validation` |
| v4.16.0 / BE-001RI-01 | `v4.16.0/1003-root.contracts.qrpc_core.strategy_ir.root_validation.unknown_marker_validation.baseline_plan.md` | `root.contracts.qrpc_core.strategy_ir.root_validation.unknown_marker_validation` baseline plan |
...
| v4.16.0 / BE-001RO-02 | `v4.16.0/1014-root.contracts.qrpc_core.protocol_primitives.extract_closeout.md` | `root.contracts.qrpc_core.protocol_primitives` actual extraction complete |
| v4.16.0 / BE-001RO-03 | `v4.16.0/1015-root.contracts.qrpc_core.protocol_primitives.single_leaf_closeout.md` | `root.contracts.qrpc_core.protocol_primitives` single leaf closeout |
...
| v4.16.0 / BE-001RT-01 | `v4.16.0/1024-root.contracts.qrpc_core.artifact_specs.parent_residual_judgment.canonical_digest.md` | `root.contracts.qrpc_core.artifact_specs` selects `canonical_digest` |
...
| v4.16.0 / BE-001RW-01 | `v4.16.0/1029-root.contracts.qrpc_core.artifact_specs.run_backtest_specs.baseline_plan.md` | `root.contracts.qrpc_core.artifact_specs.run_backtest_specs` baseline plan |
| v4.16.0 / BE-001RW-02 | `v4.16.0/1030-root.contracts.qrpc_core.artifact_specs.run_backtest_specs.extract_closeout.md` | `root.contracts.qrpc_core.artifact_specs.run_backtest_specs` actual extraction complete |
| v4.16.0 / BE-001RW-03 | `v4.16.0/1031-root.contracts.qrpc_core.artifact_specs.run_backtest_specs.single_leaf_closeout.md` | `root.contracts.qrpc_core.artifact_specs.run_backtest_specs` single leaf closeout |
| v4.16.0 / BE-001RX-01 | `v4.16.0/1032-root.contracts.qrpc_core.artifact_specs.parent_residual_judgment.artifact_bundle_contract.md` | `root.contracts.qrpc_core.artifact_specs` selects `artifact_bundle_contract` |
| v4.16.0 / BE-001RY-01 | `v4.16.0/1033-root.contracts.qrpc_core.artifact_specs.artifact_bundle_contract.baseline_plan.md` | `root.contracts.qrpc_core.artifact_specs.artifact_bundle_contract` baseline plan |
| v4.16.0 / BE-001RY-02 | `v4.16.0/1034-root.contracts.qrpc_core.artifact_specs.artifact_bundle_contract.extract_closeout.md` | `root.contracts.qrpc_core.artifact_specs.artifact_bundle_contract` actual extraction complete |
| v4.16.0 / BE-001RY-03 | `v4.16.0/1035-root.contracts.qrpc_core.artifact_specs.artifact_bundle_contract.single_leaf_closeout.md` | `root.contracts.qrpc_core.artifact_specs.artifact_bundle_contract` single leaf closeout |
| v4.16.0 / BE-001RZ-01 | `v4.16.0/1036-root.contracts.qrpc_core.artifact_specs.parent_residual_judgment.close_parent.md` | `root.contracts.qrpc_core.artifact_specs` parent closeout |
...
| v4.16.0 / BE-001SE-01 | `v4.16.0/1045-root.contracts.qrpc_core.runtime_io_contract.parent_residual_judgment.decision_flow.md` | `root.contracts.qrpc_core.runtime_io_contract` selects `decision_flow` |
| v4.16.0 / BE-001SF-01 | `v4.16.0/1046-root.contracts.qrpc_core.runtime_io_contract.decision_flow.baseline_plan.md` | `root.contracts.qrpc_core.runtime_io_contract.decision_flow` baseline plan |
| v4.16.0 / BE-001SF-02 | `v4.16.0/1047-root.contracts.qrpc_core.runtime_io_contract.decision_flow.extract_closeout.md` | `root.contracts.qrpc_core.runtime_io_contract.decision_flow` actual extraction complete |
| v4.16.0 / BE-001SF-03 | `v4.16.0/1048-root.contracts.qrpc_core.runtime_io_contract.decision_flow.single_leaf_closeout.md` | `root.contracts.qrpc_core.runtime_io_contract.decision_flow` single leaf closeout |
| v4.16.0 / BE-001SG-01 | `v4.16.0/1049-root.contracts.qrpc_core.runtime_io_contract.parent_residual_judgment.execution_io.md` | `root.contracts.qrpc_core.runtime_io_contract` selects `execution_io` |
| v4.16.0 / BE-001SH-01 | `v4.16.0/1050-root.contracts.qrpc_core.runtime_io_contract.execution_io.baseline_plan.md` | `root.contracts.qrpc_core.runtime_io_contract.execution_io` baseline plan |
| v4.16.0 / BE-001SH-02 | `v4.16.0/1051-root.contracts.qrpc_core.runtime_io_contract.execution_io.extract_closeout.md` | `root.contracts.qrpc_core.runtime_io_contract.execution_io` actual extraction complete |
...
| v4.16.0 / BE-001SJ-03 | `v4.16.0/1056-root.contracts.qrpc_core.runtime_io_contract.portfolio_state.single_leaf_closeout.md` | `root.contracts.qrpc_core.runtime_io_contract.portfolio_state` single leaf closeout |
...
| v4.16.0 / BE-001SO-01 | `v4.16.0/1065-root.contracts.qrpc_core.runtime_io_contract.parent_residual_judgment.close_parent.md` | `root.contracts.qrpc_core.runtime_io_contract` parent closeout |
...
| v4.16.0 / GOV-GOVERNANCE-NEXT-OPTIMIZATION-01 | `v4.16.0/1548-governance.governance_next_optimization.md` | Added: split decision vs governance packaging, oversized high-risk precision baseline, QPCursor generator, untracked file coverage, and index reduction route |
...
| v4.16.0 / BE-001ZK-01 | `v4.16.0/1376-root.contracts.runtime_support.data_module.mock_data_generation.baseline_plan.md` | Added: `data_module.mock_data_generation` baseline plan |
| v4.16.0 / BE-001ZK-02 | `v4.16.0/1377-root.contracts.runtime_support.data_module.mock_data_generation.extract_closeout.md` | Added: `data_module.mock_data_generation` actual extraction complete |
| v4.16.0 / BE-001ZK-03 | `v4.16.0/1378-root.contracts.runtime_support.data_module.mock_data_generation.single_leaf_closeout.md` | Added: `data_module.mock_data_generation` single leaf closeout stops split |
...
| v4.16.0 / BE-001ZO-03 | `v4.16.0/1386-root.contracts.runtime_support.data_module.http_transport.single_leaf_closeout.md` | Added: `data_module.http_transport` single leaf closeout stops split |
| v4.16.0 / BE-001ZP-01 | `v4.16.0/1387-root.contracts.runtime_support.data_module.parent_residual_judgment.test_harness.md` | Added: `data_module` parent residual judgment selects `test_harness` |
...
| v4.16.0 / BE-002AK-03 | `v4.16.0/1422-root.contracts.runtime_support.core_ir_evaluator.classic_indicator_wave.single_leaf_closeout.md` | Added: `classic_indicator_wave` single leaf closeout stops split |
| v4.16.0 / BE-002AL-01 | `v4.16.0/1423-root.contracts.runtime_support.core_ir_evaluator.parent_residual_judgment.advanced_indicator_wave.md` | Added: `core_ir_evaluator` parent residual judgment selects `advanced_indicator_wave` |
| v4.16.0 / BE-002AM-01 | `v4.16.0/1424-root.contracts.runtime_support.core_ir_evaluator.advanced_indicator_wave.baseline_plan.md` | Added: `advanced_indicator_wave` baseline plan |
| v4.16.0 / BE-002AM-02 | `v4.16.0/1425-root.contracts.runtime_support.core_ir_evaluator.advanced_indicator_wave.extract_closeout.md` | Added: `advanced_indicator_wave` actual extraction complete |
| v4.16.0 / BE-002AM-03 | `v4.16.0/1426-root.contracts.runtime_support.core_ir_evaluator.advanced_indicator_wave.single_leaf_closeout.md` | Added: `advanced_indicator_wave` single leaf closeout stops split |
| v4.16.0 / BE-002AN-01 | `v4.16.0/1427-root.contracts.runtime_support.core_ir_evaluator.parent_residual_judgment.spread_custom_expression_wave.md` | Added: `core_ir_evaluator` parent residual judgment selects `spread_custom_expression_wave` |
...
| v4.16.0 / BE-002AQ-01 | `v4.16.0/1432-root.contracts.runtime_support.core_ir_evaluator.shared_lookup_math_helpers.baseline_plan.md` | Added: `shared_lookup_math_helpers` parent-owned baseline plan |
...
| v4.16.0 / BE-002BD-01 | `v4.16.0/1450-root.contracts.runtime_support.fill_engine.event_projection_wave.extract_closeout.md` | Added: `event_projection_wave` actual extraction complete |
...
| v4.16.0 / BE-002BG-02 | `v4.16.0/1455-root.contracts.runtime_support.fill_engine.portfolio_reservation_accounting.single_leaf_closeout.md` | Added: `portfolio_reservation_accounting` single leaf closeout stops split |
| v4.16.0 / BE-002BH-01 | `v4.16.0/1456-root.contracts.runtime_support.fill_engine.parent_residual_judgment.fill_report_execution_helpers.md` | Added: `fill_engine` parent residual judgment selects `fill_report_execution_helpers` |
...
| v4.16.0 / BE-002BT-01 | `v4.16.0/1471-root.contracts.runtime_support.risk_support.parent_residual_judgment.direction_cross_constraints.md` | Added: `risk_support` parent residual judgment selects `direction_cross_constraints` |
...
| v4.16.0 / BE-002BZ-01 | `v4.16.0/1479-root.contracts.runtime_support.risk_support.parent_residual_judgment.portfolio_target_clamp_helpers.md` | Added: `risk_support` parent residual judgment selects `portfolio_target_clamp_helpers` |
| v4.16.0 / BE-002CA-01 | `v4.16.0/1480-root.contracts.runtime_support.risk_support.portfolio_target_clamp_helpers.baseline_plan.md` | Added: `portfolio_target_clamp_helpers` baseline plan |
...
| v4.16.0 / BE-002CR-01 | `v4.16.0/1502-root.contracts.runtime_support.sandbox_replay_timeline.parent_residual_judgment.replay_builder.md` | Added: `sandbox_replay_timeline` parent residual judgment selects `replay_builder` |
| v4.16.0 / BE-002CS-01 | `v4.16.0/1503-root.contracts.runtime_support.sandbox_replay_timeline.replay_builder.baseline_closeout.md` | Added: `replay_builder` baseline closeout stops split |
...
| v4.16.0 / BE-002CW-01 | `v4.16.0/1508-root.contracts.runtime_support.sandbox_replay_timeline.parent_residual_judgment.realtime_sandbox.md` | Added: `sandbox_replay_timeline` parent residual judgment selects `realtime_sandbox` |
| v4.16.0 / BE-002CX-01 | `v4.16.0/1509-root.contracts.runtime_support.sandbox_replay_timeline.realtime_sandbox.baseline_plan.md` | Added: `realtime_sandbox` baseline plan |
...
| v4.16.0 / BE-002DB-01 | `v4.16.0/1514-root.contracts.runtime_support.sandbox_replay_timeline.fast_backtest_sandbox.extract_closeout.md` | Added: `fast_backtest_sandbox` actual extraction complete |
...
| v4.16.0 / BE-002DP-01 | `v4.16.0/1532-root.contracts.runtime_support.v4_runtime_support.runtime_constructor_mode_gate.baseline_plan.md` | Added: `v4_runtime_support.runtime_constructor_mode_gate` baseline plan |
...
| v4.16.0 / BE-002DT-01 | `v4.16.0/1537-root.contracts.runtime_support.v4_runtime_support.event_replay_orchestration.extract_closeout.md` | Added: `v4_runtime_support.event_replay_orchestration` actual extraction complete |
| v4.16.0 / BE-002DT-02 | `v4.16.0/1538-root.contracts.runtime_support.v4_runtime_support.event_replay_orchestration.single_leaf_closeout.md` | Added: `v4_runtime_support.event_replay_orchestration` single leaf closeout stops split |
...
| v4.16.0 / BE-002DZ-02 | `v4.16.0/1546-root.contracts.runtime_support.v4_runtime_support.risk_execution_gate.single_leaf_closeout.md` | Added: `v4_runtime_support.risk_execution_gate` single leaf closeout stops split |
| v4.16.0 / BE-002EA-01 | `v4.16.0/1547-root.contracts.runtime_support.v4_runtime_support.parent_residual_judgment.simulated_execution_engine.md` | Added: `v4_runtime_support` parent residual judgment selects `simulated_execution_engine` |
...
| v4.16.0 / BE-002EI-02 | `v4.16.0/1560-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.order_lifecycle_flow.single_leaf_closeout.md` | Added: `simulated_execution_engine.order_lifecycle_flow` single leaf closeout stops split |
| v4.16.0 / BE-002EJ-01 | `v4.16.0/1561-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.parent_residual_judgment.market_trigger_flow.md` | Added: `simulated_execution_engine` parent residual judgment selects `market_trigger_flow` |
| v4.16.0 / BE-002EK-01 | `v4.16.0/1562-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.market_trigger_flow.baseline_plan.md` | Added: `simulated_execution_engine.market_trigger_flow` baseline plan |
| v4.16.0 / BE-002EL-01 | `v4.16.0/1563-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.market_trigger_flow.extract_closeout.md` | Added: `simulated_execution_engine.market_trigger_flow` actual extraction complete |
| v4.16.0 / BE-002EL-02 | `v4.16.0/1564-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.market_trigger_flow.single_leaf_closeout.md` | Added: `simulated_execution_engine.market_trigger_flow` single leaf closeout stops split |
| v4.16.0 / BE-002EM-01 | `v4.16.0/1565-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.parent_residual_judgment.fill_ledger_accounting.md` | Added: `simulated_execution_engine` parent residual judgment selects `fill_ledger_accounting` |
| v4.16.0 / BE-002EN-01 | `v4.16.0/1566-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.fill_ledger_accounting.baseline_plan.md` | Added: `simulated_execution_engine.fill_ledger_accounting` baseline plan |
| v4.16.0 / BE-002EO-01 | `v4.16.0/1567-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.fill_ledger_accounting.extract_closeout.md` | Added: `simulated_execution_engine.fill_ledger_accounting` actual extraction complete |
| v4.16.0 / BE-002EO-02 | `v4.16.0/1568-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.fill_ledger_accounting.single_leaf_closeout.md` | Added: `simulated_execution_engine.fill_ledger_accounting` single leaf closeout stops split |
| v4.16.0 / BE-002EP-01 | `v4.16.0/1569-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.parent_residual_judgment.snapshot_metrics_projection.md` | Added: `simulated_execution_engine` parent residual judgment selects `snapshot_metrics_projection` |
| v4.16.0 / BE-002EQ-01 | `v4.16.0/1570-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.snapshot_metrics_projection.baseline_plan.md` | Added: `simulated_execution_engine.snapshot_metrics_projection` baseline plan |
| v4.16.0 / BE-002ER-01 | `v4.16.0/1571-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.snapshot_metrics_projection.extract_closeout.md` | Added: `simulated_execution_engine.snapshot_metrics_projection` actual extraction complete |
| v4.16.0 / BE-002ER-02 | `v4.16.0/1572-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.snapshot_metrics_projection.single_leaf_closeout.md` | Added: `simulated_execution_engine.snapshot_metrics_projection` single leaf closeout stops split |
| v4.16.0 / BE-002ES-01 | `v4.16.0/1573-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.parent_residual_judgment.validation_capability_helpers.md` | Added: `simulated_execution_engine` parent residual judgment selects `validation_capability_helpers` |
| v4.16.0 / BE-002ET-01 | `v4.16.0/1574-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.validation_capability_helpers.baseline_plan.md` | Added: `simulated_execution_engine.validation_capability_helpers` baseline plan |
| v4.16.0 / BE-002EU-01 | `v4.16.0/1575-root.contracts.runtime_support.v4_runtime_support.simulated_execution_engine.validation_capability_helpers.extract_closeout.md` | Added: `simulated_execution_engine.validation_capability_helpers` actual extraction complete |
...
| v4.16.0 / BE-002EY-01 | `v4.16.0/1580-root.contracts.runtime_support.v4_runtime_support.test_harness.extract_closeout.md` | Added: `v4_runtime_support.test_harness` actual extraction complete |
...
| v4.16.0 / BE-002FB-02 | `v4.16.0/1585-root.contracts.runtime_support.v4_runtime_support.test_harness.fixture_builders.single_leaf_closeout.md` | Added: `v4_runtime_support.test_harness.fixture_builders` single leaf closeout stops split |
| v4.16.0 / BE-002FC-01 | `v4.16.0/1586-root.contracts.runtime_support.v4_runtime_support.test_harness.parent_residual_judgment.payload_validation_tests.md` | Added: `v4_runtime_support.test_harness` parent residual judgment selects `payload_validation_tests` |
| v4.16.0 / BE-002FD-01 | `v4.16.0/1587-root.contracts.runtime_support.v4_runtime_support.test_harness.payload_validation_tests.baseline_plan.md` | Added: `v4_runtime_support.test_harness.payload_validation_tests` baseline plan |
| v4.16.0 / BE-002FE-01 | `v4.16.0/1588-root.contracts.runtime_support.v4_runtime_support.test_harness.payload_validation_tests.extract_closeout.md` | Added: `v4_runtime_support.test_harness.payload_validation_tests` actual extraction complete |
| v4.16.0 / BE-002FE-02 | `v4.16.0/1589-root.contracts.runtime_support.v4_runtime_support.test_harness.payload_validation_tests.single_leaf_closeout.md` | Added: `v4_runtime_support.test_harness.payload_validation_tests` single leaf closeout stops split |
| v4.16.0 / BE-002FF-01 | `v4.16.0/1590-root.contracts.runtime_support.v4_runtime_support.test_harness.parent_residual_judgment.graph_replay_scenarios.md` | Added: `v4_runtime_support.test_harness` parent residual judgment selects `graph_replay_scenarios` |
| v4.16.0 / BE-002FG-01 | `v4.16.0/1591-root.contracts.runtime_support.v4_runtime_support.test_harness.graph_replay_scenarios.baseline_plan.md` | Added: `v4_runtime_support.test_harness.graph_replay_scenarios` baseline plan |
| v4.16.0 / BE-002FH-01 | `v4.16.0/1592-root.contracts.runtime_support.v4_runtime_support.test_harness.graph_replay_scenarios.extract_closeout.md` | Added: `v4_runtime_support.test_harness.graph_replay_scenarios` actual extraction complete |
| v4.16.0 / BE-002FH-02 | `v4.16.0/1593-root.contracts.runtime_support.v4_runtime_support.test_harness.graph_replay_scenarios.single_leaf_closeout.md` | Added: `v4_runtime_support.test_harness.graph_replay_scenarios` single leaf closeout stops split |
| v4.16.0 / BE-002FI-01 | `v4.16.0/1594-root.contracts.runtime_support.v4_runtime_support.test_harness.parent_residual_judgment.simulated_execution_scenarios.md` | Added: `v4_runtime_support.test_harness` parent residual judgment selects `simulated_execution_scenarios` |
| v4.16.0 / BE-002FJ-01 | `v4.16.0/1595-root.contracts.runtime_support.v4_runtime_support.test_harness.simulated_execution_scenarios.baseline_plan.md` | Added: `v4_runtime_support.test_harness.simulated_execution_scenarios` baseline plan |
| v4.16.0 / BE-002FK-01 | `v4.16.0/1596-root.contracts.runtime_support.v4_runtime_support.test_harness.simulated_execution_scenarios.extract_closeout.md` | Added: `v4_runtime_support.test_harness.simulated_execution_scenarios` actual extraction complete |
| v4.16.0 / BE-002FK-02 | `v4.16.0/1597-root.contracts.runtime_support.v4_runtime_support.test_harness.simulated_execution_scenarios.single_leaf_closeout.md` | Added: `v4_runtime_support.test_harness.simulated_execution_scenarios` single leaf closeout stops split |
| v4.16.0 / BE-002FL-01 | `v4.16.0/1598-root.contracts.runtime_support.v4_runtime_support.test_harness.parent_residual_judgment.runtime_recovery_snapshot_tests.md` | Added: `v4_runtime_support.test_harness` parent residual judgment selects `runtime_recovery_snapshot_tests` |
| v4.16.0 / BE-002FM-01 | `v4.16.0/1599-root.contracts.runtime_support.v4_runtime_support.test_harness.runtime_recovery_snapshot_tests.baseline_plan.md` | Added: `v4_runtime_support.test_harness.runtime_recovery_snapshot_tests` baseline plan |
| v4.16.0 / BE-002FN-01 | `v4.16.0/1600-root.contracts.runtime_support.v4_runtime_support.test_harness.runtime_recovery_snapshot_tests.extract_closeout.md` | Added: `v4_runtime_support.test_harness.runtime_recovery_snapshot_tests` actual extraction complete |
| v4.16.0 / BE-002FN-02 | `v4.16.0/1601-root.contracts.runtime_support.v4_runtime_support.test_harness.runtime_recovery_snapshot_tests.single_leaf_closeout.md` | Added: `v4_runtime_support.test_harness.runtime_recovery_snapshot_tests` single leaf closeout stops split |
| v4.16.0 / BE-002FO-01 | `v4.16.0/1602-root.contracts.runtime_support.v4_runtime_support.test_harness.parent_residual_judgment.live_capability_guard_tests.md` | Added: `v4_runtime_support.test_harness` parent residual judgment selects `live_capability_guard_tests` |
...
| v4.16.0 / BE-002GC-01 | `v4.16.0/1623-root.contracts.quantscript.typed_resolution.parent_residual_judgment.public_type_surface.md` | Added: `quantscript.typed_resolution` parent residual judgment selects `public_type_surface` |
...
| v4.16.0 / BE-002GF-01 | `v4.16.0/1628-root.contracts.quantscript.typed_resolution.callable_classification_surface.baseline_plan.md` | Added: `quantscript.typed_resolution.callable_classification_surface` baseline plan |
| v4.16.0 / BE-002GF-02 | `v4.16.0/1629-root.contracts.quantscript.typed_resolution.callable_classification_surface.extract_closeout.md` | Added: `quantscript.typed_resolution.callable_classification_surface` actual extraction complete |
| v4.16.0 / BE-002GF-03 | `v4.16.0/1630-root.contracts.quantscript.typed_resolution.callable_classification_surface.single_leaf_closeout.md` | Added: `quantscript.typed_resolution.callable_classification_surface` single leaf closeout stops split |
| v4.16.0 / BE-002GG-01 | `v4.16.0/1631-root.contracts.quantscript.typed_resolution.parent_residual_judgment.semantic_inference_surface.md` | Added: `quantscript.typed_resolution` parent residual judgment selects `semantic_inference_surface` |
| v4.16.0 / BE-002GH-01 | `v4.16.0/1632-root.contracts.quantscript.typed_resolution.semantic_inference_surface.baseline_plan.md` | Added: `quantscript.typed_resolution.semantic_inference_surface` baseline plan |
| v4.16.0 / BE-002GH-02 | `v4.16.0/1633-root.contracts.quantscript.typed_resolution.semantic_inference_surface.extract_closeout.md` | Added: `quantscript.typed_resolution.semantic_inference_surface` actual extraction complete |
| v4.16.0 / BE-002GH-03 | `v4.16.0/1634-root.contracts.quantscript.typed_resolution.semantic_inference_surface.single_leaf_closeout.md` | Added: `quantscript.typed_resolution.semantic_inference_surface` single leaf closeout stops split |
| v4.16.0 / BE-002GI-01 | `v4.16.0/1635-root.contracts.quantscript.typed_resolution.parent_residual_judgment.type_inference_binding_surface.md` | Added: `quantscript.typed_resolution` parent residual judgment selects `type_inference_binding_surface` |
| v4.16.0 / BE-002GJ-01 | `v4.16.0/1636-root.contracts.quantscript.typed_resolution.type_inference_binding_surface.baseline_plan.md` | Added: `quantscript.typed_resolution.type_inference_binding_surface` baseline plan |
| v4.16.0 / BE-002GJ-02 | `v4.16.0/1637-root.contracts.quantscript.typed_resolution.type_inference_binding_surface.extract_closeout.md` | Added: `quantscript.typed_resolution.type_inference_binding_surface` actual extraction complete |
...
| v4.16.0 / BE-002GL-03 | `v4.16.0/1642-root.contracts.quantscript.typed_resolution.resolver_orchestration_surface.single_leaf_closeout.md` | Added: `quantscript.typed_resolution.resolver_orchestration_surface` single leaf closeout stops split |
| v4.16.0 / BE-002GM-01 | `v4.16.0/1643-root.contracts.quantscript.typed_resolution.parent_residual_judgment.resolver_support_surface.md` | Added: `quantscript.typed_resolution` parent residual judgment selects `resolver_support_surface` |
| v4.16.0 / BE-002GN-01 | `v4.16.0/1644-root.contracts.quantscript.typed_resolution.resolver_support_surface.baseline_plan.md` | Added: `quantscript.typed_resolution.resolver_support_surface` baseline plan |
...
| v4.16.0 / BE-002HC-03 | `v4.16.0/1675-root.contracts.quantscript.analysis_diagnostics.symbol_whitelist_gate.single_leaf_closeout.md` | Added: `quantscript.analysis_diagnostics.symbol_whitelist_gate` single leaf closeout stops split |
| v4.16.0 / BE-002HD-01 | `v4.16.0/1676-root.contracts.quantscript.analysis_diagnostics.parent_residual_judgment.fetch_lookback_warning_gate.md` | Added: `quantscript.analysis_diagnostics` parent residual judgment selects `fetch_lookback_warning_gate` |
| v4.16.0 / BE-002HE-01 | `v4.16.0/1677-root.contracts.quantscript.analysis_diagnostics.fetch_lookback_warning_gate.baseline_plan.md` | Added: `quantscript.analysis_diagnostics.fetch_lookback_warning_gate` baseline plan |
| v4.16.0 / BE-002HE-02 | `v4.16.0/1678-root.contracts.quantscript.analysis_diagnostics.fetch_lookback_warning_gate.extract_closeout.md` | Added: `quantscript.analysis_diagnostics.fetch_lookback_warning_gate` actual extraction complete |
| v4.16.0 / BE-002HE-03 | `v4.16.0/1679-root.contracts.quantscript.analysis_diagnostics.fetch_lookback_warning_gate.single_leaf_closeout.md` | Added: `quantscript.analysis_diagnostics.fetch_lookback_warning_gate` single leaf closeout stops split |
| v4.16.0 / BE-002HF-01 | `v4.16.0/1680-root.contracts.quantscript.analysis_diagnostics.parent_residual_judgment.index_bounds_gate.md` | Added: `quantscript.analysis_diagnostics` parent residual judgment selects `index_bounds_gate` |
| v4.16.0 / BE-002HG-01 | `v4.16.0/1681-root.contracts.quantscript.analysis_diagnostics.index_bounds_gate.baseline_plan.md` | Added: `quantscript.analysis_diagnostics.index_bounds_gate` baseline plan |
...
| v4.16.0 / BE-002HI-02 | `v4.16.0/1686-root.contracts.quantscript.analysis_diagnostics.dead_code_emit_gate.extract_closeout.md` | Added: `quantscript.analysis_diagnostics.dead_code_emit_gate` actual extraction complete |
| v4.16.0 / BE-002HI-03 | `v4.16.0/1687-root.contracts.quantscript.analysis_diagnostics.dead_code_emit_gate.single_leaf_closeout.md` | Added: `quantscript.analysis_diagnostics.dead_code_emit_gate` single leaf closeout stops split |
| v4.16.0 / BE-002HJ-01 | `v4.16.0/1688-root.contracts.quantscript.analysis_diagnostics.parent_residual_judgment.strategy_presence_gate.md` | Added: `quantscript.analysis_diagnostics` parent residual judgment selects `strategy_presence_gate` |
| v4.16.0 / BE-002HK-01 | `v4.16.0/1689-root.contracts.quantscript.analysis_diagnostics.strategy_presence_gate.baseline_plan.md` | Added: `quantscript.analysis_diagnostics.strategy_presence_gate` baseline plan |
...
| v4.16.0 / BE-002HN-01 | `v4.16.0/1694-root.contracts.quantscript.evaluator_normalization.baseline_plan.md` | Added: `quantscript.evaluator_normalization` baseline plan |
| v4.16.0 / BE-002HN-02 | `v4.16.0/1695-root.contracts.quantscript.evaluator_normalization.module_shell_extraction.md` | Added: `quantscript.evaluator_normalization` module shell extraction |
| v4.16.0 / BE-002HO-01 | `v4.16.0/1696-root.contracts.quantscript.evaluator_normalization.parent_residual_judgment.folding_value_wave.md` | Added: `quantscript.evaluator_normalization` parent residual judgment selects `folding_value_wave` |
| v4.16.0 / BE-002HP-01 | `v4.16.0/1697-root.contracts.quantscript.evaluator_normalization.folding_value_wave.baseline_plan.md` | Added: `quantscript.evaluator_normalization.folding_value_wave` baseline plan |
| v4.16.0 / BE-002HP-02 | `v4.16.0/1698-root.contracts.quantscript.evaluator_normalization.folding_value_wave.extract_closeout.md` | Added: `quantscript.evaluator_normalization.folding_value_wave` actual extraction complete |
...
| v4.16.0 / BE-002HR-03 | `v4.16.0/1703-root.contracts.quantscript.evaluator_normalization.helper_inline_execution_wave.single_leaf_closeout.md` | Added: `quantscript.evaluator_normalization.helper_inline_execution_wave` single leaf closeout stops split |
| v4.16.0 / BE-002HS-01 | `v4.16.0/1704-root.contracts.quantscript.evaluator_normalization.parent_closeout.md` | Added: `quantscript.evaluator_normalization` parent closeout |
...
| v4.16.0 / BE-002HX-01 | `v4.16.0/1709-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.parent_residual_judgment.profile_detection_surface.md` | Added: `quantscript.runtime_lowering.lowering_orchestrator_surface` parent residual judgment selects `profile_detection_surface` |
| v4.16.0 / BE-002HY-01 | `v4.16.0/1710-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.profile_detection_surface.baseline_plan.md` | Added: `quantscript.runtime_lowering.lowering_orchestrator_surface.profile_detection_surface` baseline plan |
| v4.16.0 / BE-002HY-02 | `v4.16.0/1711-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.profile_detection_surface.extract_closeout.md` | Added: `quantscript.runtime_lowering.lowering_orchestrator_surface.profile_detection_surface` actual extraction complete |
| v4.16.0 / BE-002HY-03 | `v4.16.0/1712-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.profile_detection_surface.single_leaf_closeout.md` | Added: `quantscript.runtime_lowering.lowering_orchestrator_surface.profile_detection_surface` single leaf closeout stops split |
| v4.16.0 / BE-002HZ-01 | `v4.16.0/1713-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.parent_residual_judgment.integration_test_harness.md` | Added: `quantscript.runtime_lowering.lowering_orchestrator_surface` parent residual judgment selects `integration_test_harness` |
| v4.16.0 / BE-002IA-01 | `v4.16.0/1714-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.baseline_plan.md` | Added: `quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness` baseline plan |
| v4.16.0 / BE-002IA-02 | `v4.16.0/1715-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.extract_closeout.md` | Added: `quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness` actual extraction complete |
| v4.16.0 / BE-002IA-03 | `v4.16.0/1716-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.single_leaf_closeout.md` | Added: `quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness` single leaf closeout keeps split open |
| v4.16.0 / BE-002IB-01 | `v4.16.0/1717-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.parent_residual_judgment.manual_formula_tests.md` | Added: `integration_test_harness` parent residual judgment selects `manual_formula_tests` |
| v4.16.0 / BE-002IC-01 | `v4.16.0/1718-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.manual_formula_tests.baseline_plan.md` | Added: `integration_test_harness.manual_formula_tests` baseline plan |
| v4.16.0 / BE-002IC-02 | `v4.16.0/1719-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.manual_formula_tests.extract_closeout.md` | Added: `integration_test_harness.manual_formula_tests` actual extraction complete |
| v4.16.0 / BE-002IC-03 | `v4.16.0/1720-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.manual_formula_tests.single_leaf_closeout.md` | Added: `integration_test_harness.manual_formula_tests` single leaf closeout stops split |
| v4.16.0 / BE-002ID-01 | `v4.16.0/1721-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.parent_residual_judgment.spread_lowering_tests.md` | Added: `integration_test_harness` parent residual judgment selects `spread_lowering_tests` |
| v4.16.0 / BE-002IE-01 | `v4.16.0/1722-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.spread_lowering_tests.baseline_plan.md` | Added: `integration_test_harness.spread_lowering_tests` baseline plan |
| v4.16.0 / BE-002IE-02 | `v4.16.0/1723-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.spread_lowering_tests.extract_closeout.md` | Added: `integration_test_harness.spread_lowering_tests` actual extraction complete |
| v4.16.0 / BE-002IE-03 | `v4.16.0/1724-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.spread_lowering_tests.single_leaf_closeout.md` | Added: `integration_test_harness.spread_lowering_tests` single leaf closeout stops split |
| v4.16.0 / BE-002IF-01 | `v4.16.0/1725-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.parent_residual_judgment.rebalance_lowering_tests.md` | Added: `integration_test_harness` parent residual judgment selects `rebalance_lowering_tests` |
| v4.16.0 / BE-002IG-01 | `v4.16.0/1726-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.rebalance_lowering_tests.baseline_plan.md` | Added: `integration_test_harness.rebalance_lowering_tests` baseline plan |
| v4.16.0 / BE-002IG-02 | `v4.16.0/1727-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.rebalance_lowering_tests.extract_closeout.md` | Added: `integration_test_harness.rebalance_lowering_tests` actual extraction complete |
| v4.16.0 / BE-002IG-03 | `v4.16.0/1728-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.rebalance_lowering_tests.single_leaf_closeout.md` | Added: `integration_test_harness.rebalance_lowering_tests` single leaf closeout stops split |
| v4.16.0 / BE-002IH-01 | `v4.16.0/1729-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.parent_residual_judgment.basic_runtime_smoke_tests.md` | Added: `integration_test_harness` parent residual judgment selects `basic_runtime_smoke_tests` |
| v4.16.0 / BE-002II-01 | `v4.16.0/1730-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.basic_runtime_smoke_tests.baseline_plan.md` | Added: `integration_test_harness.basic_runtime_smoke_tests` baseline plan |
| v4.16.0 / BE-002II-02 | `v4.16.0/1731-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.basic_runtime_smoke_tests.extract_closeout.md` | Added: `integration_test_harness.basic_runtime_smoke_tests` actual extraction complete |
| v4.16.0 / BE-002II-03 | `v4.16.0/1732-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.basic_runtime_smoke_tests.single_leaf_closeout.md` | Added: `integration_test_harness.basic_runtime_smoke_tests` single leaf closeout stops split |
| v4.16.0 / BE-002IJ-01 | `v4.16.0/1733-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.integration_test_harness.parent_closeout.md` | Added: `integration_test_harness` parent closeout |
| v4.16.0 / BE-002IK-01 | `v4.16.0/1734-root.contracts.quantscript.runtime_lowering.lowering_orchestrator_surface.parent_residual_judgment.entrypoint_runtime_config_assembly.md` | Added: `lowering_orchestrator_surface` parent residual judgment selects `entrypoint_runtime_config_assembly` |
...
| v4.16.0 / BE-002IR-01 | `v4.16.0/1745-root.contracts.quantscript.runtime_lowering.universe_lowering.parent_residual_judgment.universe_construct_expansion.md` | Added: `universe_lowering` parent residual judgment selects `universe_construct_expansion` |
| v4.16.0 / BE-002IS-01 | `v4.16.0/1746-root.contracts.quantscript.runtime_lowering.universe_lowering.universe_construct_expansion.baseline_plan.md` | Added: `universe_construct_expansion` baseline plan |
...
| v4.16.0 / BE-002IV-01 | `v4.16.0/1751-root.contracts.quantscript.runtime_lowering.intent_inference.baseline_plan.md` | Added: `intent_inference` precision baseline plan |
...
| v4.16.0 / BE-002IZ-03 | `v4.16.0/1759-root.contracts.quantscript.runtime_lowering.intent_inference.single_indicator_intent_inference.single_leaf_closeout.md` | Added: `single_indicator_intent_inference` single leaf closeout stops split |
| v4.16.0 / BE-002JA-01 | `v4.16.0/1760-root.contracts.quantscript.runtime_lowering.intent_inference.parent_residual_judgment.spread_intent_inference.md` | Added: `intent_inference` parent residual judgment selects `spread_intent_inference` |
...
| v4.16.0 / BE-002JK-01 | `v4.16.0/1776-root.contracts.quantscript.runtime_lowering.manual_formula_fallback.manual_macd_formula.baseline_plan.md` | Added: `manual_macd_formula` baseline plan |
| v4.16.0 / BE-002JK-02 | `v4.16.0/1777-root.contracts.quantscript.runtime_lowering.manual_formula_fallback.manual_macd_formula.extract_closeout.md` | Added: `manual_macd_formula` actual extraction complete |
...
| v4.16.0 / BE-002JX-01 | `v4.16.0/1799-root.contracts.quantscript.v4_static_audit.parent_residual_judgment.event_catalog_derivation.md` | Added: `v4_static_audit` parent residual judgment selects `event_catalog_derivation` |
...
| v4.16.0 / BE-002KB-01 | `v4.16.0/1807-root.contracts.quantscript.v4_static_audit.parent_residual_judgment.static_document_parser.md` | Added: `v4_static_audit` parent residual judgment selects `static_document_parser` |
| v4.16.0 / BE-002KC-01 | `v4.16.0/1808-root.contracts.quantscript.v4_static_audit.static_document_parser.baseline_plan.md` | Added: `static_document_parser` baseline plan |
| v4.16.0 / BE-002KC-02 | `v4.16.0/1809-root.contracts.quantscript.v4_static_audit.static_document_parser.extract_closeout.md` | Added: `static_document_parser` actual extraction complete |
| v4.16.0 / BE-002KC-03 | `v4.16.0/1810-root.contracts.quantscript.v4_static_audit.static_document_parser.single_leaf_closeout.md` | Added: `static_document_parser` single leaf closeout stops split |
| v4.16.0 / BE-002KD-01 | `v4.16.0/1811-root.contracts.quantscript.v4_static_audit.parent_residual_judgment.machine_block_parser.md` | Added: `v4_static_audit` parent residual judgment selects `machine_block_parser` |
| v4.16.0 / BE-002KE-01 | `v4.16.0/1812-root.contracts.quantscript.v4_static_audit.machine_block_parser.baseline_plan.md` | Added: `machine_block_parser` baseline plan |
| v4.16.0 / BE-002KE-02 | `v4.16.0/1813-root.contracts.quantscript.v4_static_audit.machine_block_parser.extract_closeout.md` | Added: `machine_block_parser` actual extraction complete |
...
| v4.16.0 / BE-002KG-03 | `v4.16.0/1818-root.contracts.quantscript.v4_static_audit.state_block_parser.single_leaf_closeout.md` | Added: `state_block_parser` single leaf closeout stops split |
| v4.16.0 / BE-002KH-01 | `v4.16.0/1819-root.contracts.quantscript.v4_static_audit.parent_residual_judgment.transition_parser.md` | Added: `v4_static_audit` parent residual judgment selects `transition_parser` |
| v4.16.0 / BE-002KI-01 | `v4.16.0/1820-root.contracts.quantscript.v4_static_audit.transition_parser.baseline_plan.md` | Added: `transition_parser` baseline plan |
| v4.16.0 / BE-002KI-02 | `v4.16.0/1821-root.contracts.quantscript.v4_static_audit.transition_parser.extract_closeout.md` | Added: `transition_parser` actual extraction complete |
| v4.16.0 / BE-002KI-03 | `v4.16.0/1822-root.contracts.quantscript.v4_static_audit.transition_parser.single_leaf_closeout.md` | Added: `transition_parser` single leaf closeout stops split |
| v4.16.0 / BE-002KJ-01 | `v4.16.0/1823-root.contracts.quantscript.v4_static_audit.parent_residual_judgment.memory_parser.md` | Added: `v4_static_audit` parent residual judgment selects `memory_parser` |
...
| v4.16.0 / BE-002KM-02 | `v4.16.0/1829-root.contracts.quantscript.v4_static_audit.edge_parser.extract_closeout.md` | Added: `edge_parser` actual extraction complete |
| v4.16.0 / BE-002KM-03 | `v4.16.0/1830-root.contracts.quantscript.v4_static_audit.edge_parser.single_leaf_closeout.md` | Added: `edge_parser` single leaf closeout stops split |
...
| v4.16.0 / BE-002KZ-01 | `v4.16.0/1847-root.contracts.parent_closeout.md` | Added: `contracts` parent closeout |
| v4.16.0 / BE-002LA-01 | `v4.16.0/1848-root.parent_residual_judgment.executor.md` | Added: `root` parent residual judgment selects `executor` |
| v4.16.0 / BE-002LB-01 | `v4.16.0/1849-root.executor.baseline_plan.md` | Added: `executor` baseline plan |
...
| v4.16.0 / BE-002LE-01 | `v4.16.0/1854-root.executor.parent_residual_judgment.runner.md` | Added: `executor` parent residual judgment selects `runner` |
...
| v4.16.0 / BE-002LJ-02 | `v4.16.0/1862-root.executor.runner.strategy_lifecycle_routes.extract_closeout.md` | Added: `strategy_lifecycle_routes` handler extraction complete |
| v4.16.0 / BE-002LJ-03 | `v4.16.0/1863-root.executor.runner.strategy_lifecycle_routes.single_leaf_closeout.md` | Added: `strategy_lifecycle_routes` single leaf closeout stops split |
| v4.16.0 / BE-002LK-01 | `v4.16.0/1864-root.executor.runner.parent_residual_judgment.market_stream_routes.md` | Added: `executor.runner` parent residual judgment selects `market_stream_routes` |
| v4.16.0 / BE-002LL-01 | `v4.16.0/1865-root.executor.runner.market_stream_routes.baseline_plan.md` | Added: `market_stream_routes` baseline plan |
| v4.16.0 / BE-002LL-02 | `v4.16.0/1866-root.executor.runner.market_stream_routes.extract_closeout.md` | Added: `market_stream_routes` handler extraction complete |
...
| v4.16.0 / BE-002LS-02 | `v4.16.0/1880-root.executor.runner.runner_support_files.okx_rest.parent_residual_judgment.signing_request_surface.md` | Added: `okx_rest` parent residual judgment selects `signing_request_surface` |
...
| v4.16.0 / BE-002LV-01 | `v4.16.0/1885-root.executor.runner.runner_support_files.okx_rest.transport_response_surface.baseline_plan.md` | Added: `transport_response_surface` baseline plan |
| v4.16.0 / BE-002LV-02 | `v4.16.0/1886-root.executor.runner.runner_support_files.okx_rest.transport_response_surface.extract_closeout.md` | Added: `transport_response_surface` helper extraction complete |
...
| v4.16.0 / BE-002LZ-02 | `v4.16.0/1894-root.executor.runner.runner_support_files.okx_rest.lookup_validation_surface.extract_closeout.md` | Added: `lookup_validation_surface` actual extraction closeout |
...
| v4.16.0 / BE-002MF-01 | `v4.16.0/1904-root.executor.runner.runner_support_files.live_runner.v3_live_runner.baseline_plan.md` | Added: `v3_live_runner` baseline plan |
| v4.16.0 / BE-002MF-02 | `v4.16.0/1905-root.executor.runner.runner_support_files.live_runner.v3_live_runner.extract_closeout.md` | Added: `v3_live_runner` actual extraction closeout |
...
| v4.16.0 / BE-002MH-03 | `v4.16.0/1910-root.executor.runner.runner_support_files.live_runner.runner_instance_dispatch.single_leaf_closeout.md` | Added: `runner_instance_dispatch` single leaf closeout stops split |
...
| v4.16.0 / BE-002MN-03 | `v4.16.0/1922-root.executor.runner.runner_support_files.live_runner.v4_market_metadata_helpers.single_leaf_closeout.md` | Added: `v4_market_metadata_helpers` single leaf closeout stops split |
