...
| frontend.module.builtin.agent.arbitrage | builtin.agent.arbitrage | trace_only | frontend editor owner | sidebar exposure, disabled reasons, UX | frontend:support-matrix.frontend.supportedModuleKeys | 该模块键可能在 Beta 代码路径中保持可见，但这并不代表真正的套利平台支持。 |
