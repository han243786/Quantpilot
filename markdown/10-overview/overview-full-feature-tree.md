...
| `/api/runtime/experiments/*` | 实验/参数扫描 | `src/backend/runtime/routes.rs`、`src/runtime/backtest/experiment_sweep.rs`、`src/runtime/backtest/parameter_grid.rs`、`src/runtime/backtest/start_orchestration.rs` |
