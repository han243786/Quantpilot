...
当前架构补充: BE-001X-01 已确认 `runtime.backtest.experiment_sweep` 父叶仍 `stop_split: false`，下一候选为 `start_orchestration`。
当前最新递归点: 下一步只能进入 BE-001Y-01 `runtime.backtest.experiment_sweep.start_orchestration` 单子叶等价基线。
