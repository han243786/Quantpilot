...
> 冷热定位: current summary + historical roadmap；当前摘要保持紧凑，长历史增量迁入 milestone、archive 或专门治理批次。
...
Latest recursive supplement: BE-002JG-03 closed `contracts.quantscript.runtime_lowering.manual_formula_fallback.manual_rsi_formula` with `stop_split: true`; next step returns to manual_formula_fallback parent residual judgment.
Latest recursive supplement: BE-002JH-01 selected `contracts.quantscript.runtime_lowering.manual_formula_fallback.manual_momentum_formula`; next baseline freezes momentum direct and ratio fallback recognition only.
Latest recursive supplement: BE-002JI-01 froze `contracts.quantscript.runtime_lowering.manual_formula_fallback.manual_momentum_formula`; next movement may extract momentum direct/ratio recognition and legacy latest/lookback matching.
Latest recursive supplement: BE-002JI-02 extracted `contracts.quantscript.runtime_lowering.manual_formula_fallback.manual_momentum_formula`; next step is single leaf closeout.
Latest recursive supplement: BE-002JI-03 closed `contracts.quantscript.runtime_lowering.manual_formula_fallback.manual_momentum_formula` with `stop_split: true`; next step returns to manual_formula_fallback parent residual judgment.
...
Latest recursive supplement: BE-002JL-01 selected `contracts.quantscript.runtime_lowering.manual_formula_fallback.manual_zscore_formula`; next baseline freezes direct ZScore and legacy operand recovery only.
...
Latest recursive supplement: BE-002KC-02 extracted `contracts.quantscript.v4_static_audit.static_document_parser`; next step is single leaf closeout.
Latest recursive supplement: BE-002KC-03 closed `contracts.quantscript.v4_static_audit.static_document_parser` with `stop_split: true`; next step returns to v4_static_audit parent residual judgment.
Latest recursive supplement: BE-002KD-01 selected `contracts.quantscript.v4_static_audit.machine_block_parser`; next baseline freezes machine envelope parsing and machine contract assembly.
Latest recursive supplement: BE-002KE-01 froze `contracts.quantscript.v4_static_audit.machine_block_parser`; next movement may extract the machine block parser wrapper boundary.
Latest recursive supplement: BE-002KE-02 extracted `contracts.quantscript.v4_static_audit.machine_block_parser`; next step is single leaf closeout.
Latest recursive supplement: BE-002KE-03 closed `contracts.quantscript.v4_static_audit.machine_block_parser` with `stop_split: true`; next step returns to v4_static_audit parent residual judgment.
...
Latest recursive supplement: BE-002KK-03 closed `contracts.quantscript.v4_static_audit.memory_parser` with `stop_split: true`; next step returns to v4_static_audit parent residual judgment.
Latest recursive supplement: BE-002KL-01 selected `contracts.quantscript.v4_static_audit.edge_parser`; next baseline freezes graph edge parsing.
Latest recursive supplement: BE-002KM-01 froze `contracts.quantscript.v4_static_audit.edge_parser`; next movement may extract only edge declaration parsing and `MachineGraphEdge` assembly.
Latest recursive supplement: BE-002KM-02 extracted `contracts.quantscript.v4_static_audit.edge_parser`; next step is single leaf closeout.
...
Latest recursive supplement: BE-002LI-01 selected `executor.runner.strategy_lifecycle_routes`; next baseline freezes strategy lifecycle handler extraction.
Latest recursive supplement: BE-002LJ-01 froze `strategy_lifecycle_routes`; next movement may extract only list/detail/deploy/start/stop handlers.
...
Latest recursive supplement: BE-002LL-02 extracted kline/SSE handlers into `src-executor/market_stream_routes.rs`; next step is single leaf closeout.
...
Latest recursive supplement: BE-002LX-02 extracted `order_action_surface`; next step is single leaf closeout.
...
Latest recursive supplement: BE-002MH-03 closed `live_runner.runner_instance_dispatch` with `stop_split: true`; next step returns to `live_runner` parent residual judgment.
Latest recursive supplement: BE-002MI-01 selected `live_runner.v4_runner`; next baseline freezes V4 live runner movement.
...
Latest recursive supplement: BE-002ML-01 froze `runner_pool_orchestration`; next movement may extract RunnerPool and direct impl.
Latest recursive supplement: BE-002ML-02 extracted `runner_pool_orchestration`; next step is single leaf closeout.
...
Latest recursive supplement: BE-002MV-01 selected `runner_support_files.migration_api`; next baseline freezes migration API support-file movement.
