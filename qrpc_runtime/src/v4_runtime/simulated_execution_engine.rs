...
impl V4PaperSimulatedRuntime {
    ...
    pub(super) fn apply_runtime_simulated_execution_for_transition(
        &mut self,
        machine_id: &str,
    ...
    pub(super) fn validate_simulated_order_capabilities(
        &self,
    ...
    pub(super) fn record_simulated_execution_events(
        &mut self,
