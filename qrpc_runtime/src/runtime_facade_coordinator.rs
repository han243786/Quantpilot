use crate::{
    agent_module::{AgentEvaluationRequest, AgentModuleProvider, BuiltinAgentModule},
    config_tracker,
    data_module::{BuiltinDataModule, DataCollectionRequest, DataModuleProvider},
    execution_module::{BuiltinExecutionModule, ExecutionModuleProvider, ExecutionPlanningRequest},
    intent_module::{BuiltinIntentModule, IntentEvaluationRequest, IntentModuleProvider},
    merge::{MergeDecisionRecord, MergePolicy, StrategyInput, StrategyMergeEngine},
    merge_coordinator,
    risk_checker::{RiskCheckOutput, RiskCheckRequest, RiskChecker, RiskCheckerProvider},
