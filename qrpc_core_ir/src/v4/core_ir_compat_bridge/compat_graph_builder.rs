mod event_catalog_builder;

use event_catalog_builder::build_core_ir_compat_event_catalog;
...
use crate::v4::{
    ...
    MachineTransition, QsScalarTypeKind, QsTypeRef, StateGroup, TransitionConflictPolicy,
    V4MachineContract, V4MachineGraphContract, V4_COMPAT_CORE_IR_LOADED_EVENT,
