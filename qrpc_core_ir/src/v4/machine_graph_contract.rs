...
use super::{
    default_machine_event_catalog_version, default_machine_graph_contract_version,
    default_machine_graph_edge_activation, default_risk_plane_min_priority, default_true,
    MachineTemplateKind, V4MachineContract, V4_MACHINE_EVENT_CATALOG_VERSION,
    V4_MACHINE_GRAPH_CONTRACT_VERSION, V4_RISK_PLANE_MIN_PRIORITY,
};
...
pub(super) fn collect_machine_family<'a>(
...
pub(super) fn machine_nested_depth(machine: &V4MachineContract) -> u32 {
