...
use qrpc_core_ir::v4::{
    ...
    RuntimeTradingMode, StateGroup, V4CompileTimeCapabilityReport, V4CompileTimeCapabilityRequest,
    V4MachineGraphContract, V4StaticContractBundle,
};
...
fn parse_state_group(input: &str, line_number: usize) -> Result<StateGroup, Diagnostic> {
    state_group_parser::parse_state_group(input, line_number)
}
