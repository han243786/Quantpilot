...
use qrpc_core_ir::v4::{
    ...
    StateGroup, TransitionConflictPolicy, V4CompileTimeCapabilityReport,
    V4CompileTimeCapabilityRequest, V4MachineContract, V4MachineGraphContract,
    V4StaticContractBundle, V4_COMPILE_TIME_CAPABILITY_REQUEST_VERSION,
    V4_MACHINE_CONTRACT_VERSION, V4_MACHINE_EVENT_CATALOG_VERSION,
...
mod tests {
    use super::*;
    use qrpc_core_ir::v4::V4CapabilityReportVerdict;
    use qrpc_core_ir::v4::{
