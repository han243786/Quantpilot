...
pub const ERR_QSC_BAD_REQUEST: &str = "QSC4000";
pub const ERR_QSC_EMPTY_INTENT: &str = "QSC4001";
pub const ERR_QSC_CAPABILITY_GATED: &str = "QSC4002";
pub const ERR_QSC_CONTRACT_INVALID: &str = "QSC4003";
...
pub const ERR_QPRT_EQUITY_CURVE_NON_MONOTONIC: &str = "QPRT4101";

// 告警
pub const ERR_ALERT_NOT_FOUND: &str = "ALERT_NOT_FOUND";
...
mod tests {
    ...
    fn all_error_codes_are_non_empty() {
        let codes = [
            ...
            ERR_GRAPH_ID_EMPTY,
            ERR_GRAPH_ID_TOO_LONG,
            ERR_GRAPH_ID_INVALID_CHARS,
            ERR_GRAPH_NOT_FOUND,
            ERR_GRAPH_SAVE_FAILED,
            ERR_GRAPH_DELETE_FAILED,
            ERR_STRATEGY_EMPTY_INTENT,
            ERR_COMPILE_CAPABILITY_GATED,
            ERR_COMPILE_FAILED,
            ERR_QS_GENERATION_FAILED,
            ERR_QS_PARSE_FAILED,
            ERR_QS_LOWER_FAILED,
            ERR_COMPILE_BUSY,
            ERR_QSC_BAD_REQUEST,
            ERR_QSC_EMPTY_INTENT,
            ERR_QSC_CAPABILITY_GATED,
            ERR_QSC_CONTRACT_INVALID,
            ERR_RUN_IN_PROGRESS,
            ERR_RUN_NOT_FOUND,
            ERR_RUNTIME_CAPABILITY,
            ERR_RUNTIME_CONFIG_INVALID,
            ERR_QPRT_EQUITY_CURVE_NON_MONOTONIC,
            ERR_ALERT_NOT_FOUND,
            ERR_BACKTEST_NOT_FOUND,
            ERR_BACKTEST_COMPARE_TWO_IDS,
            ERR_AUTH_UNAUTHORIZED,
            ERR_AUTH_LOGIN_FAILED,
            ERR_AUTH_REGISTER_FAILED,
            ERR_AUTH_TOKEN_EXPIRED,
            ERR_AUTH_RATE_LIMITED,
            ERR_CREDENTIAL_VAULT_UNAVAIL,
            ERR_CREDENTIAL_SAVE_FAILED,
            ERR_CREDENTIAL_DELETE_FAILED,
