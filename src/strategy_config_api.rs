...
pub(super) struct StrategyConfigArtifactRequest {
    #[serde(default)]
    pub(super) strategy_id: Option<String>,
    #[serde(default)]
    pub(super) strategy_version: Option<String>,
    #[serde(default)]
    pub(super) source_mode: Option<String>,
    #[serde(default)]
    pub(super) graph_json: Option<Value>,
    #[serde(default)]
    pub(super) runtime_config: Option<Value>,
    #[serde(default)]
    pub(super) qs_source: Option<String>,
    #[serde(default)]
    pub(super) core_ir: Option<Value>,
    #[serde(default)]
    pub(super) v4_graph: Option<Value>,
    #[serde(default)]
    pub(super) capability_snapshot_hash: Option<String>,
    #[serde(default)]
    pub(super) capability_source: Option<String>,
    #[serde(default)]
    pub(super) runtime_mode: Option<String>,
    #[serde(default)]
    pub(super) evidence_anchors: Vec<EvidenceAnchorInput>,
    #[serde(default)]
    pub(super) proposal_bindings: Vec<ProposalBindingInput>,
    #[serde(default)]
    pub(super) required_execution_capability_sources: Vec<String>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub(super) struct StrategyConfigArtifact {
    pub(super) schema_version: String,
    pub(super) artifact_id: String,
    pub(super) strategy_id: String,
    pub(super) strategy_version: String,
    pub(super) created_at_ms: u64,
    pub(super) source: StrategyConfigSourceSummary,
    pub(super) capability: StrategyConfigCapabilitySummary,
    pub(super) config_domains: Vec<ConfigDomainStatus>,
    pub(super) runtime_boundary: RuntimeBoundarySummary,
    pub(super) evidence_anchors: Vec<EvidenceAnchor>,
    pub(super) proposal_bindings: Vec<ProposalBinding>,
    pub(super) artifact_digest: String,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub(super) struct StrategyConfigSourceSummary {
    pub(super) source_mode: String,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(super) graph_digest: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(super) runtime_config_digest: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(super) qs_digest: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(super) core_ir_digest: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(super) v4_graph_digest: Option<String>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub(super) struct StrategyConfigCapabilitySummary {
    pub(super) capability_snapshot_hash: String,
    pub(super) capability_expected_hash: String,
    pub(super) capability_snapshot_status: String,
    pub(super) capability_source: String,
    pub(super) frontend_module_keys: Vec<String>,
    pub(super) ui_actions: Vec<String>,
    pub(super) workspace_surfaces: Vec<String>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub(super) struct ConfigDomainStatus {
    pub(super) domain_id: ConfigDomainId,
    pub(super) lifecycle: ConfigDomainLifecycle,
    pub(super) readiness: ConfigDomainReadiness,
    pub(super) source_refs: Vec<ConfigSourceRef>,
    pub(super) findings: Vec<StrategyConfigFinding>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(super) primary_action: Option<String>,
}

#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq, PartialOrd, Ord)]
#[serde(rename_all = "snake_case")]
pub(super) enum ConfigDomainId {
    Market,
    Observation,
    StateMachine,
    Risk,
...
#[serde(rename_all = "snake_case")]
pub(super) enum ConfigDomainLifecycle {
    Implemented,
    Documentable,
    Milestone,
    Unsupported,
...
#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub(super) enum ConfigDomainReadiness {
    Ready,
    Incomplete,
    Restricted,
    Stale,
...
pub(super) struct ConfigSourceRef {
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub(super) struct StrategyConfigFinding {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub(super) struct RuntimeBoundarySummary {
    pub(super) mode_label: String,
    pub(super) provider_order_submission_attached: bool,
    pub(super) provider_order_submission_allowed: bool,
    pub(super) live_execution_allowed: bool,
    pub(super) execution_capability_sources: Vec<String>,
    pub(super) rejection_reasons: Vec<String>,
}

#[derive(Debug, Clone, Deserialize)]
pub(super) struct EvidenceAnchorInput {
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub(super) struct EvidenceAnchor {
    pub(super) anchor_type: String,
...
#[derive(Debug, Clone, Deserialize)]
pub(super) struct ProposalBindingInput {
    pub(super) proposal_id: String,
    pub(super) target_domain: ConfigDomainId,
    #[serde(default)]
    pub(super) before_digest: Option<String>,
    #[serde(default)]
    pub(super) after_digest: Option<String>,
    #[serde(default)]
    pub(super) evidence_anchor_ids: Vec<String>,
    #[serde(default)]
    pub(super) sandbox_status: Option<String>,
    #[serde(default)]
    pub(super) approval_status: Option<String>,
}

#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub(super) struct ProposalBinding {
    pub(super) proposal_id: String,
    pub(super) target_domain: ConfigDomainId,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub(super) before_digest: Option<String>,
...
fn build_strategy_config_artifact(
    request: StrategyConfigArtifactRequest,
    now_ms: u64,
